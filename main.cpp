...
// SCENE 4 - MOVING CAR
// ============================================================
// A small car built from a body quad, a roof polygon, two windows,
// and four circles for the wheels (outer tire + inner hub). It is
// drawn in a local coordinate space of roughly (-2..2, 0..2) and then
// scaled/translated onto the road, matching the style used elsewhere
// in this file (drawCargoPlane, drawCrashPlane, etc).
...
// ============================================================
// SCENE 4 - SECOND MOVING CAR
// ============================================================
// Same design as the first car, but with a different body color.
// It moves from right to left on the upper road lane.
...
void renderScene4() {
    ...
    // Moving car, driving along the lower road lane (below the yellow
    // centerline) and wrapping around once it leaves the right edge.
...
void update(int value) {
    ...
    // Advance the Scene 4 car and wrap it back to the left once it
    // drives off the right edge of the window.
    carX += CAR_SPEED;
